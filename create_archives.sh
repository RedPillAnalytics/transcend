...
zip -r ./evolve_unwrapped.zip ./plsql/specs/*.*s ./plsql/bodies/*.*b  ./install/install_evolve.sql ./evolve/java/* ./evolve/plsql/specs/*.*s ./evolve/plsql/bodies/*.*b
...
zip -r ./transcend_unwrapped.zip ./plsql/specs/*.*s ./plsql/bodies/*.*b ./evolve/java/* ./evolve/plsql/specs/*.*s ./evolve/plsql/bodies/*.*b
