...
BEGIN   
   ...
   THEN
      ...
      EXECUTE IMMEDIATE 'create or replace synonym &syn_schema_as..td_sql for &obj_schema_as..td_sql';
      EXECUTE IMMEDIATE 'create or replace synonym &syn_schema_as..td_core for &obj_schema_as..td_core';
