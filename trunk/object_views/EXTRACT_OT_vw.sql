...
SELECT cast('runtime' AS VARCHAR2(10)) runmode,
       ...
       dirpath,
       filename,
       td_core.get_dir_path (directory) || '/' || filename filepath,
       arch_directory,
       arch_dirpath,
       arch_filename,
       td_core.get_dir_path (arch_directory) || '/' || arch_filename arch_filepath,
       file_datestamp,
       min_bytes,
       max_bytes,
       baseurl,
  ...
  FROM (SELECT filehub_id,
               ...
               object_name,
               directory,
	       td_core.get_dir_path (directory) dirpath,
	       ...
	       WHEN 'NA'
               ...
               END arch_filename,
               arch_directory,
	       td_core.get_dir_path (arch_directory) arch_dirpath,
	       file_datestamp,
               min_bytes,
               max_bytes,
               baseurl,
