...
CREATE TABLE efw.file_ctl
	 ...
	 regexp_ci_ind		VARCHAR2(1) DEFAULT 'N' NOT NULL,
	 source_dir	 	VARCHAR2(50) NOT NULL,
	 min_bytes		NUMBER,
	 max_bytes              NUMBER,
	 arch_dir        	VARCHAR2(50) NOT NULL,
	 add_arch_ts_ind	VARCHAR2(1) DEFAULT 'N' NOT NULL,
	 wrk_dir	 	VARCHAR2(50),
	 ext_dir		VARCHAR2(50),
	 ext_filename    	VARCHAR2(30),
	 ext_table		VARCHAR2(30),
	 ext_tab_owner		VARCHAR2(30),
	 multi_files_action	VARCHAR2(10),
	 files_required_ind	VARCHAR2(1) DEFAULT 'Y' NOT NULL,	 
