...
IS
   ...
   BEGIN
	 ...
	 ( 
	   ...
	   source_policy       VARCHAR2(10) 	DEFAULT 'newest' NOT NULL,
	   required            VARCHAR2(3) 	DEFAULT 'yes' NOT NULL,
	   delete_source       VARCHAR2(3)     	DEFAULT 'yes' NOT NULL,
	   reject_limit        NUMBER		DEFAULT 100 NOT NULL,
	   ...
	   delimiter	       VARCHAR2(3)    	DEFAULT ',' NOT NULL,
	   quotechar	       VARCHAR2(2),
	   headers	       VARCHAR2(3)	DEFAULT 'yes' NOT NULL,
