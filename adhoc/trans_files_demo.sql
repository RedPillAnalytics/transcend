...
-- CREATE a test feed
EXEC trans_adm.create_feed( 'test feed','test group',p_directory=>'extdata',p_filename=>'TEST_FEED.dat',p_owner=>'stewart',p_table=>'test_feed',p_work_directory=>'workdata', p_baseurl=>'www.transcendentdata.com/files',p_passphrase=>'passw0rd',p_source_directory=>'sourcedata',p_source_regexp=>'txt$',p_source_policy=>'newest',p_delete_source=>'no', p_compress_method=>trans_adm.extension_method, p_required=>'no');

-- CREATE a test extract
EXEC trans_adm.create_extract( 'test feed','test group',p_filename=>'TEST_EXTRACT.dat',p_object_owner=>'stewart',p_object_name=>'test_extract',p_work_directory=>'workdata',p_baseurl=>'www.transcendentdata.com/files',p_passphrase=>'passw0rd',p_directory=>'extractdata');
